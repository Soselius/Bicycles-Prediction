# -*- coding: utf-8 -*-
"""
Created on Mon Dec 20 19:55:52 2021
...
model = load_model(f'my_model_Lambda{n}_outputs{n_outputs}_N{n_cells}.h5')
...
scipy.io.savemat(f'Prediction_onehot_LSTM_L{n}_o{n_window}_outputs{n_outputs}_N{n_cells}.mat', {f'Prediction_onehot_LSTM_L{n}_o{n_window}_outputs{n_outputs}_N{n_cells}': [prob_start, prediction_perSeq, output1_perSeq, output2_perSeq, output3_perSeq, output4_perSeq, output5_perSeq]})
